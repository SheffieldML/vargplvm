...
fieldsToKeep = ...
    ...
    'nParams','learnBeta', 'dynamics', 'iters', 'date', 'fixedBetaIters', 'dataSetInfo','id', 'learnInducing', ...
    'initVardist', 'initVardistIters', 'saveName', 'globalOpt', 'KLweight', 'fixParamIndices', ...
    'latentIndices', 'paramPriors', 'fixIndices', 'windowSize'}';
