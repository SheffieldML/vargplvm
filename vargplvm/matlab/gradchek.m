...
%%%
counterLength = 20;
counterPrintStep = round(nparams/counterLength);
for i=1:counterLength
    fprintf(1,'.');
end
fprintf(1,'|\n');
%%%
...
% %%%
%  global tempGradientName
%  global tempDeltafName
%  global tempDeltaName
% % 
% tempGradientName
% tempDeltafName
% tempDeltaName
...
%  save(tempGradientName, 'theGradient');%%%
%  save(tempDeltafName, 'deltaf');%%%
%  save(tempDeltaName, 'delta'); %%%

%%% OR
fprintf(1,'Saving delta, gradient(analytic) and deltaf (numerical)...\n');
 save 'gradient.mat' 'gradient';%%%
 save 'deltaf.mat' 'deltaf';%%%
...
% % Then:
% % dStable = norm(deltafStable - gradientStable)/norm(gradientStable + deltafStable); %%
