function [class, d_class] = nn_class2(X,X_test,k,dist_type, varargin) 
...
if strcmp(dist_type,'weighted')
    d = dist_func(X,X_test, varargin{1});
else
...
function D = dist_weighted(V, X, w)
N = size(X,1);
W = repmat(w, N,1); 
