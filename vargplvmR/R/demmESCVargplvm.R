demmESC<-function(dataSetName ="mESC",  
                   dataDir = system.file("extdata",package="vargplvm"), 
                   iters = 10, seed = 1e5, kernoptions = "rbfard2",
                   createDir = TRUE, runVargplvmDir = getwd(),
                   overwriteDir = TRUE)
{
  # % DEMMESCVARGPLVM1 Run variational GPLVM on mESC data.
  # % FORMAT
  # % DESC 
  ...
  #  plot the two largest two latent dimensions 
  #   to do print
