% SHEFFIELDMLPREDICTIONS2 This script implements the predictions for a classification task
%
% SEEALSO : demClassification, demClassification3, demClassificationGeneral, svargplvmPredictions, svargplvmPredictions3
%
